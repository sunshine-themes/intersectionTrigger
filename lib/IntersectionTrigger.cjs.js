        ...
        const validateOption = (optionName2, optionValue2) => {
          switch (optionName2) {
            ...
            case "name":
              ...
              break;
            case "animation":
              !this._helpers.is.anime(optionValue2) && !this._helpers.is.tl(optionValue2) && this._helpers.throwError("animation parameter must be an anime instance or timeline.");
              break;
            case "toggleClass":
              !this._helpers.is.string(optionValue2) && !this._helpers.is.array(optionValue2) && this._helpers.throwError("toggleClass parameter must be a string or an Array.");
              break;
            case "onEnter":
            case "onEnterBack":
            case "onLeave":
