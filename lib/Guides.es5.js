  ...
  var Guides = /* @__PURE__ */ function() {
    ...
    _createClass(Guides2, [{
      ...
      value: function createGuides() {
        var _this3 = this;
        var isVirtical = this._helpers.is.virtical();
        var createGuide = function createGuide2(options) {
          ...
          var positionGuide = function positionGuide2() {
            ...
            var targetBounds = isTrigger ? _this3._helpers.boundsMinusScrollbar(trigger) : _this3._utils.getRootRect(_this3._it.observer.rootMargin);
            var rBoundsNoMargins = _this3._it._root ? _this3._helpers.boundsMinusScrollbar(_this3._it._root) : _this3._helpers.boundsMinusScrollbar(document.body);
          ...
          positionGuide();
          _this3._helpers.getParents(trigger).forEach(function(parent) {
            if (!_this3._helpers.is.scrollable(parent))
              return;
        ...
        var parseGuidesParams = function parseGuidesParams2(params) {
          ...
          if (_this3._helpers.is.object(params)) {
            guideParams2 = _this3._helpers.mergeOptions(guideParams2, params);
          }
          return guideParams2;
        };
