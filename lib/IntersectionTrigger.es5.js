...
var intersectiontrigger = (function() {
    ...
    _createClass(Utils2, [{
      ...
      value: function setUtils() {
        ...
        this.onTriggerEnter = function(trigger) {
          ...
          toggleClass && _this._it.toggleClass.toggle(trigger, toggleClass, data.eventIndex);
          animation && _this._it.animation.animate(trigger, animation, data.eventIndex);
  ...
  IntersectionTrigger.registerPlugins = function() {
    var newPlugins = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
    return registeredPlugins.push.apply(registeredPlugins, _toConsumableArray2(newPlugins));
  };
