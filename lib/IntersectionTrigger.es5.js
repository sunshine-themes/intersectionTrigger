    ...
    _createClass(Utils2, [{
      ...
      value: function setUtils() {
        ...
        this.animate = function(trigger, animation, eventIndex) {
          var instance = animation.instance, toggleActions = animation.toggleActions, control = animation.control;
          if (!instance)
            return;
          if (control) {
            ...
            var animateHandler = function animateHandler2(trigger2) {
              ...
              if (diff > 0) {
                var currentTime = duration * diff / (tIL + rB[length]);
                if (is.num(control)) {
                  setTimeout(function() {
            ...
            case is.object(params):
              {
                ...
                var toggleActions = mergedParams.toggleActions;
