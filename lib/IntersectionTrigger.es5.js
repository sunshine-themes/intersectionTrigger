    ...
    _createClass(Utils2, [{
      ...
      value: function setUtils() {
        ...
        this.onTriggerEnter = function(trigger) {
          ...
          data.callback(trigger, _this._it);
          if (_this._it.killed)
            return _this.kill();
  ...
  var IntersectionTrigger = /* @__PURE__ */ function() {
    function IntersectionTrigger2() {
      ...
      _defineProperty2(this, "_onScrollHandler", function() {
        return _this._rAFID = requestAnimationFrame(_this._rAFCallback);
      });
      _defineProperty2(this, "_observerCallback", function(entries, observer) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            ...
            var initBackupFun = tB[length] >= rL, isBackupFunRunning = !!backup;
            switch (true) {
    ...
    _createClass2(IntersectionTrigger2, [{
      key: "_setPlugin",
      value: function _setPlugin(pluginName, propertyName) {
        var plugins = IntersectionTrigger2.getRegisteredPlugins();
        var Plugin = plugins.find(function(plg) {
          return pluginName === plg.name;
        });
      ...
      value: function add() {
        ...
        var parseProp = function parseProp2(name, pluginName) {
          !_this3[name] && _this3._setPlugin(pluginName, name);
          triggerParams[name] = _this3[name].parse(triggerParams[name]);
        };
      ...
      value: function update() {
        ...
        newTriggers && newTriggers.forEach(function(trigger) {
          return _this5._utils.setTriggerData(trigger, triggerParams);
        });
        this._createInstance();
        this.triggers.forEach(function(trigger) {
          return _this5.observer.observe(trigger);
        });
        this._guidesInstance && this._guidesInstance.update();
      }
    }]);
