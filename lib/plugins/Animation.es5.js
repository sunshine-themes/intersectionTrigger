    ...
    _createClass(Animation2, [{
      ...
      value: function animate(trigger, animation, eventIndex) {
        ...
        if (control) {
          ...
          var _this$_utils$getTrigg2 = this._utils.getTriggerData(trigger), enter = _this$_utils$getTrigg2.enter, leave = _this$_utils$getTrigg2.leave;
          ...
          var animateHandler = function animateHandler2(trigger2) {
            ...
            var ids2 = _this._utils.getTriggerStates(trigger2, "ids");
            ...
            if (snap) {
              var speed = Math.round(Math.max(snap.speed * 17 / 1e3, 1));
              var dis = 0;
              ...
              _this._utils.setTriggerStates(trigger2, {
