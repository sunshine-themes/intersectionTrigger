    ...
    _createClass(Animation2, [{
      ...
      value: function animate(trigger, animation, eventIndex) {
        ...
        if (control) {
          ...
          var seek = function seek2(t) {
            return instance.seek(t);
          };
          var animateHandler = function animateHandler2(trigger2) {
            ...
            var currentTime = 0;
            var _this$_utils$getPosit = _this._utils.getPositions(tB2, rB, {
              enter: enter,
              leave: leave,
              ref: ref,
            ...
            if (snap) {
              ...
              var snapTimeOutId = setTimeout(function() {
                var directionalDiff = snap.to.map(function(n) {
                  ...
                  return Math.abs(n);
                }), closest = Math.min.apply(Math, _toConsumableArray(diff2)), closestWithDirection = directionalDiff[diff2.indexOf(closest)], snapDistance = scrollLength * closest / duration;
