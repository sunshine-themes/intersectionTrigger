    ...
    _createClass(Animation2, [{
      ...
      value: function init() {
        ...
        this.animateHandler = function(trigger, _ref2) {
          var enter = _ref2.enter, leave = _ref2.leave, tIL = _ref2.tIL, instance = _ref2.instance, duration = _ref2.duration, snap = _ref2.snap, step = _ref2.step, link = _ref2.link;
          ...
          if (diff > 0) {
            ...
            _this.seek(instance, currentTime, link);
          }
          if (snap) {
            var dis = 0;
        ...
        if (link) {
          ...
          switch (eventIndex) {
            ...
            case 3:
              ...
              this.seek(instance, eventIndex === 1 ? duration : 0, link);
              break;
          }
          return;
        }
